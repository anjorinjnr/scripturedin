    var BibleService = function ($http, util, $q, $state, bibleBooks) {
    ...
    BibleService.prototype.parseScripture = function scrip(text) {
        ...
        while ((m = re.exec(text)) !== null) {
            ...
            var translation_regex = /(amp|asv|ceb|cevdcus06|cpdv|erv|esv|gnb|gnt|gntd|icb|kjv|kjva|kjva|mev|msg|nabre|nasb|ncv|net|nirv|niv|nkjv|nlt|web|webbe|wmb|wmbbe)/i;
    ...
    BibleService.prototype.changeTranslation = function (scripture, translation) {
        var self = this;
        var scripture_ = angular.copy(scripture);
        scripture_.translation = translation.toLowerCase();
        return self.getPassage(scripture_);
    };
    ...
    BibleService.prototype.findBook = function (str) {
     ...
     angular.module(MODULE_NAME).service('bibleService', BibleService);
