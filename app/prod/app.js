var App = angular.module('scripturedIn', [
    ...
    .run(["$rootScope", "alertService", "util", "authService", "$state", "$mdToast", "sidebarToggle", function ($rootScope, alertService, util, authService, $state, $mdToast, sidebarToggle) {
...
App.controller('appController', ["$scope", "sidebarToggle", function ($scope, sidebarToggle) {
...
(function () {
    ...
    NotesCtrl.$inject = ["userService", "bibleService", "$scope", "$state", "note", "$q", "$scope", "noteService", "alertService"];
...
(function () {
    ...
    App.directive('showScriptureOnClick', ["bibleService", function (bibleService) {
        ...
        .directive('scripture', ["bibleService", function (bibleService) {
            return {
                restrict: 'E',
                scope: {
                    //scripture: '='
...
App
    ...
    .directive('feed', ["authService", "util", "userService", function (authService, util, userService) {
        return {
            restrict: 'E',
            scope: {
                feed: '='
...
$templateCache.put("module/component/scripture/scripture-modal.html","<div class=\"modal-body\">\n    <scripture text=\"modalCtrl.scripture\"></scripture>\n</div>\n<!--<div class=\"modal-footer\">-->\n   <!---->\n<!--</div>-->\n");
$templateCache.put("module/component/scripture/scripture.html","<div class=\"chapter\">\n\n    <div class=\"m-b-10 card-header p-l-0 p-b-5\">\n        <h2>{{scripture.book}} </h2>\n        <ul class=\"actions\">\n            <li class=\"dropdown\" uib-dropdown>\n                Select Translation\n                <a href=\"\" uib-dropdown-toggle>\n\n                    <i class=\"zmdi zmdi-translate\"></i>\n                    <md-tooltip>Change translation</md-tooltip>\n                </a>\n\n                <ul class=\"dropdown-menu dropdown-menu-right translations\"\n                    style=\"max-height: 400px; overflow-y: scroll\">\n                    <li ng-class=\"{selected: scripture.version == v.abbr }\"\n                        ng-repeat=\"v in versions\">\n                        <a ng-click=\"changeTranslation(v)\" href\n                        >{{::v.title}}</a>\n                    </li>\n                </ul>\n            </li>\n        </ul>\n    </div>\n\n    <h3 class=\"title\">Chapter {{scripture.chapter}}</h3>\n\n    <div id=\"verses\">\n        <p id=\"v{{verse}}\" class=\"verse\" ng-class=\"{highlight: readCtrl.selected[book][verse]}\"\n           ng-repeat=\"v in scripture.verses\">\n            <a href=\"\" ng-click=\"readCtrl.highlight(verse, book)\">\n                <span style=\"margin-right: 15px\">{{v.verse}}:</span></a>\n            {{v.content}}\n        </p>\n    </div>\n\n</div>");}]);